...
void FOVRLipSyncVisemesDataReadyDelegate_DelegateWrapper(const FMulticastScriptDelegate& OVRLipSyncVisemesDataReadyDelegate)
{
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_ConvaiOVRLipSync_Source_OVRLipSync_Public_OVRLipSyncActorComponentBase_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_ConvaiOVRLipSync_Source_OVRLipSync_Public_OVRLipSyncActorComponentBase_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_ConvaiOVRLipSync_Source_OVRLipSync_Public_OVRLipSyncActorComponentBase_h_460782380(TEXT("/Script/OVRLipSync"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_ConvaiOVRLipSync_Source_OVRLipSync_Public_OVRLipSyncActorComponentBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_ConvaiOVRLipSync_Source_OVRLipSync_Public_OVRLipSyncActorComponentBase_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
